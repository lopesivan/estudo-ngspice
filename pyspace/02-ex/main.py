...
# When we add an element to a circuit, we can get a
# reference to it or ignore it:
...
# We can get back an element of a circuit using its name,
# either as a class attribute or using the dictionary interface:
...
# To get the SPICE netlist of a citcuit, we just have
